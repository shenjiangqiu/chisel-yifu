...
module mem_63x80(
  ...
  assign R0_data = _R0_en_d0 ? Memory[_R0_addr_d0] : 80'bx;
endmodule
...
module linearSearchMem(
  ...
  assign wrData_0_id = _GEN ? 8'hFF : wr_data_0_id;
  assign wrData_1_event_superCycle = _GEN ? 32'hFFFFFFFF : wr_data_1_event_superCycle;
  assign wrData_1_id = _GEN ? 8'hFF : wr_data_1_id;
  assign wrMask_0 = _GEN | wr_mask[0];
  assign wrMask_1 = _GEN | wr_mask[1];
  wire [6:0]      _pointerReg_T_2 = pointerReg + 7'h1;
  wire [3:0][5:0] _GEN_0 =
    {{rd_address},
     {rd_address},
     {_pointerReg_T_2[5:0]},
     {srch_search ? 6'h0 : rd_address}};
  always @(posedge clock) begin
    ...
    if (reset) begin
      ...
      automatic logic            resVec_0 = _mem_ext_R0_data[39:32] == srch_refID;
      automatic logic            resVec_1 = _mem_ext_R0_data[79:72] == srch_refID;
      automatic logic            _GEN_1 = (|{resVec_1, resVec_0}) | ~srch_search;
      automatic logic [7:0]      _lastAddr_T_1 = srch_heapSize - 8'h1;
      automatic logic            _GEN_2 =
        pointerReg >= (srch_heapSize == 8'h0 ? 7'h0 : _lastAddr_T_1[7:1]);
      automatic logic [3:0][1:0] _GEN_3 =
        {{stateReg},
         {{pointerReg != 7'h41, 1'h0}},
         {{1'h0, ~(_GEN_1 | _GEN_2)}},
         {{1'h0, srch_search}}};
      automatic logic [3:0][6:0] _GEN_4 =
        {{pointerReg},
         {pointerReg + 7'h1},
         {_GEN_1
            ? {pointerReg[5:0], 1'h0} + {6'h0, ~resVec_0 & resVec_1} + 7'h1
            : _pointerReg_T_2},
         {srch_search ? 7'h0 : pointerReg}};
  ...
  mem_63x80 mem_ext (
    ...
    .W0_mask ({{5{wrMask_1}}, {5{wrMask_0}}}),
    .R0_data (_mem_ext_R0_data)
  );
  assign rd_data_0_event_superCycle = _mem_ext_R0_data[31:0];
  assign rd_data_0_id = _mem_ext_R0_data[39:32];
  assign rd_data_1_event_superCycle = _mem_ext_R0_data[71:40];
  assign rd_data_1_id = _mem_ext_R0_data[79:72];
...
module Heapifier(
  ...
  wire [6:0]  _GEN_7 = {1'h0, _nextIndexUp_T[6:1]};
  ...
  assign addressIndex =
    _GEN_1 | _GEN_18
      ? indexReg
      : _GEN_6 ? _GEN_7 : _GEN_16 ? indexReg : _nextIndexDown_T_1[6:0];
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      childrenReg_0_id <= 8'h0;
      childrenReg_1_event_superCycle <= 32'h0;
      childrenReg_1_id <= 8'h0;
    end
    else begin
      ...
      if (_GEN_1) begin
        ...
        if (~_GEN_18) begin
          if (_GEN_6)
            ...
            indexReg <= _nextIndexDown_T_1[6:0];
        end
        if (~_GEN_13) begin
          if (_GEN_5)
  ...
  assign io_rdPort_address =
    _GEN_2
      ? addressIndex[5:0]
      : _GEN_3
          ? _ramAddressParent_T[6:1]
          : _GEN_17
              ? 6'h0
              : _GEN_32
                  ? _ramAddressParent_T[6:1]
                  : _GEN_9 | ~_GEN_31 ? addressIndex[5:0] : 6'h0;
...
module QueueControl(
  ...
  input  [7:0]  io_cmd_refID,
  input  [31:0] io_rdPort_data_0_event_superCycle,
  input  [7:0]  io_rdPort_data_0_id,
  input  [31:0] io_rdPort_data_1_event_superCycle,
  input  [7:0]  io_rdPort_data_1_id,
  input  [6:0]  io_srch_res,
  input         io_srch_error,
                io_srch_done,
  output        io_head_valid,
                io_head_none,
  output [31:0] io_head_prio_superCycle,
  output [7:0]  io_head_refID,
  output        io_cmd_done,
                io_cmd_result,
  ...
  reg  [7:0]       tempReg_0_id;
  reg  [31:0]      tempReg_1_event_superCycle;
  reg  [7:0]       tempReg_1_id;
  reg  [6:0]       removalIndex;
  reg  [31:0]      removedPrio_superCycle;
  reg              headValid;
  reg              errorReg;
  wire [6:0]       _wrIndexToRam_T = wrIndex - 7'h1;
  wire             wrIndexOffset = (|wrIndex) & wrIndex[0] - 1'h1;
  wire [6:0]       _rdIndexToRam_T = rdIndex - 7'h1;
  wire             rdIndexOffset = (|rdIndex) & rdIndex[0] - 1'h1;
  wire [7:0]       _heapifier_io_control_idx_T_1 = heapSizeReg - 8'h1;
  ...
  wire [7:0]       _GEN_10 = rdIndexOffset ? _heapifier_io_wrPort_data_0_id : 8'hFF;
  wire [31:0]      _GEN_11 =
    rdIndexOffset ? 32'hFFFFFFFF : _heapifier_io_wrPort_data_1_event_superCycle;
  wire [7:0]       _GEN_12 = rdIndexOffset ? 8'hFF : _heapifier_io_wrPort_data_1_id;
  ...
  wire [7:0]       _GEN_17 = rdIndexOffset ? tempReg_1_id : tempReg_0_id;
  ...
  wire [15:0][6:0] _GEN_22 =
    {{7'h0},
     ...
     {removalIndex},
     {heapSizeReg[6:0]},
     {_heapifier_io_control_idx_T_1[6:0]},
     {heapSizeReg[6:0]},
     {7'h0},
     {heapSizeReg[6:0]}};
  ...
  wire [6:0]       _heapifier_io_control_idx_T_6 = removalIndex - 7'h1;
  wire             _GEN_28 = stateReg == 4'hA;
  wire [7:0]       _GEN_29 = {removalIndex, 1'h0} + 8'h1;
  wire             _GEN_30 = ~io_cmd_op & ~_heapifier_io_control_swapped & ~(_GEN_29[7]);
  always @(posedge clock) begin
    if (reset) begin
      stateReg <= 4'h0;
      heapSizeReg <= 8'h0;
      ...
      automatic logic             _GEN_32 = heapSizeReg == 8'h1;
      automatic logic             _GEN_33;
      automatic logic             _GEN_34;
      automatic logic             _GEN_35;
      automatic logic [15:0][3:0] _GEN_36;
      _GEN_31 = heapSizeReg == 8'h80;
      ...
      if (_GEN) begin
        ...
        automatic logic [7:0] _incHeapsize_T;
        _incHeapsize_T = heapSizeReg + 8'h1;
        if (_GEN_4)
  ...
  Heapifier heapifier (
    ...
    .io_control_idx
      (_GEN_25
         ? heapSizeReg[6:0]
         : _GEN_1
             ? (heapSizeReg < 8'h3 ? 7'h0 : _heapifier_io_control_idx_T_1[7:1])
             : _GEN_18
                 ? heapSizeReg[6:0]
                 : _GEN_15
                     ? 7'h0
                     : _GEN_20
                         ...
                         : _GEN_21
                             ? {1'h0,
                                removalIndex < 7'h3
                                  ? 6'h0
                                  : _heapifier_io_control_idx_T_6[6:1]}
  ...
  assign io_rdPort_address =
    _GEN | ~(_GEN_7 | ~_GEN_6) ? _rdIndexToRam_T[6:1] : _heapifier_io_rdPort_address;
  assign io_wrPort_address =
              ...
              : _GEN_8
                  ...
                  : _GEN_14
                      ...
                      : _GEN_15
                          ? _GEN_10
                          : _GEN_20
                              ? (wrIndexOffset ? _heapifier_io_wrPort_data_0_id : 8'hFF)
              ...
              : _GEN_8
                  ...
                  : _GEN_14
                      ...
                      : _GEN_15
                          ? _GEN_12
                          : _GEN_20
                              ? (wrIndexOffset ? 8'hFF : _heapifier_io_wrPort_data_1_id)
...
module PriorityQueue(
  ...
  wire [5:0]  _queue_io_rdPort_address;
  wire [5:0]  _queue_io_wrPort_address;
  wire [1:0]  _queue_io_wrPort_mask;
  wire [31:0] _queue_io_wrPort_data_0_event_superCycle;
  wire [7:0]  _queue_io_wrPort_data_0_id;
  wire [31:0] _queue_io_wrPort_data_1_event_superCycle;
  wire [7:0]  _queue_io_wrPort_data_1_id;
  wire        _queue_io_wrPort_write;
  wire [7:0]  _queue_io_srch_refID;
  wire [7:0]  _queue_io_srch_heapSize;
  wire        _queue_io_srch_search;
  wire [31:0] _mem_rd_data_0_event_superCycle;
  wire [7:0]  _mem_rd_data_0_id;
  wire [31:0] _mem_rd_data_1_event_superCycle;
  wire [7:0]  _mem_rd_data_1_id;
  wire [6:0]  _mem_srch_res;
