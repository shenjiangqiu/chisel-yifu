...
module mem_7x74(
  ...
  assign R0_data = _R0_en_d0 ? Memory[_R0_addr_d0] : 74'bx;
endmodule
...
module linearSearchMem(
  ...
  assign wrData_0_id = _GEN ? 5'h1F : wr_data_0_id;
  assign wrData_1_event_superCycle = _GEN ? 32'hFFFFFFFF : wr_data_1_event_superCycle;
  assign wrData_1_id = _GEN ? 5'h1F : wr_data_1_id;
  assign wrMask_0 = _GEN | wr_mask[0];
  assign wrMask_1 = _GEN | wr_mask[1];
  wire [3:0]      _pointerReg_T_2 = pointerReg + 4'h1;
  wire [3:0][2:0] _GEN_0 =
    {{rd_address},
     {rd_address},
     {_pointerReg_T_2[2:0]},
     {srch_search ? 3'h0 : rd_address}};
  always @(posedge clock) begin
    ...
    if (reset) begin
      ...
      automatic logic            resVec_0 = _mem_ext_R0_data[36:32] == srch_refID;
      automatic logic            resVec_1 = _mem_ext_R0_data[73:69] == srch_refID;
      automatic logic            _GEN_1 = (|{resVec_1, resVec_0}) | ~srch_search;
      automatic logic [4:0]      _lastAddr_T_1 = srch_heapSize - 5'h1;
      automatic logic            _GEN_2 =
        pointerReg >= (srch_heapSize == 5'h0 ? 4'h0 : _lastAddr_T_1[4:1]);
      automatic logic [3:0][1:0] _GEN_3 =
        {{stateReg},
         {{pointerReg != 4'h9, 1'h0}},
         {{1'h0, ~(_GEN_1 | _GEN_2)}},
         {{1'h0, srch_search}}};
      automatic logic [3:0][3:0] _GEN_4 =
        {{pointerReg},
         {pointerReg + 4'h1},
         {_GEN_1
            ? {pointerReg[2:0], 1'h0} + {3'h0, ~resVec_0 & resVec_1} + 4'h1
            : _pointerReg_T_2},
         {srch_search ? 4'h0 : pointerReg}};
  ...
  mem_7x74 mem_ext (
    ...
    .W0_mask ({{37{wrMask_1}}, {37{wrMask_0}}}),
    .R0_data (_mem_ext_R0_data)
  );
  assign rd_data_0_event_superCycle = _mem_ext_R0_data[31:0];
  assign rd_data_0_id = _mem_ext_R0_data[36:32];
  assign rd_data_1_event_superCycle = _mem_ext_R0_data[68:37];
  assign rd_data_1_id = _mem_ext_R0_data[73:69];
...
module Heapifier(
  ...
  wire [3:0]  _GEN_7 = {1'h0, _nextIndexUp_T[3:1]};
  ...
  assign addressIndex =
    _GEN_1 | _GEN_18
      ? indexReg
      : _GEN_6 ? _GEN_7 : _GEN_16 ? indexReg : _nextIndexDown_T_1[3:0];
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      childrenReg_0_id <= 5'h0;
      childrenReg_1_event_superCycle <= 32'h0;
      childrenReg_1_id <= 5'h0;
    end
    else begin
      ...
      if (_GEN_1) begin
        ...
        if (~_GEN_18) begin
          if (_GEN_6)
            ...
            indexReg <= _nextIndexDown_T_1[3:0];
        end
        if (~_GEN_13) begin
          if (_GEN_5)
  ...
  assign io_rdPort_address =
    _GEN_2
      ? addressIndex[2:0]
      : _GEN_3
          ? _ramAddressParent_T[3:1]
          : _GEN_17
              ? 3'h0
              : _GEN_32
                  ? _ramAddressParent_T[3:1]
                  : _GEN_9 | ~_GEN_31 ? addressIndex[2:0] : 3'h0;
...
module QueueControl(
  ...
  input  [4:0]  io_cmd_refID,
  input  [31:0] io_rdPort_data_0_event_superCycle,
  input  [4:0]  io_rdPort_data_0_id,
  input  [31:0] io_rdPort_data_1_event_superCycle,
  input  [4:0]  io_rdPort_data_1_id,
  input  [3:0]  io_srch_res,
  input         io_srch_error,
                io_srch_done,
  output        io_head_valid,
                io_head_none,
  output [31:0] io_head_prio_superCycle,
  output [4:0]  io_head_refID,
  output        io_cmd_done,
                io_cmd_result,
  ...
  reg  [4:0]       tempReg_0_id;
  reg  [31:0]      tempReg_1_event_superCycle;
  reg  [4:0]       tempReg_1_id;
  reg  [3:0]       removalIndex;
  reg  [31:0]      removedPrio_superCycle;
  reg              headValid;
  reg              errorReg;
  wire [3:0]       _wrIndexToRam_T = wrIndex - 4'h1;
  wire             wrIndexOffset = (|wrIndex) & wrIndex[0] - 1'h1;
  wire [3:0]       _rdIndexToRam_T = rdIndex - 4'h1;
  wire             rdIndexOffset = (|rdIndex) & rdIndex[0] - 1'h1;
  wire [4:0]       _heapifier_io_control_idx_T_1 = heapSizeReg - 5'h1;
  ...
  wire [4:0]       _GEN_10 = rdIndexOffset ? _heapifier_io_wrPort_data_0_id : 5'h1F;
  wire [31:0]      _GEN_11 =
    rdIndexOffset ? 32'hFFFFFFFF : _heapifier_io_wrPort_data_1_event_superCycle;
  wire [4:0]       _GEN_12 = rdIndexOffset ? 5'h1F : _heapifier_io_wrPort_data_1_id;
  ...
  wire [4:0]       _GEN_17 = rdIndexOffset ? tempReg_1_id : tempReg_0_id;
  ...
  wire [15:0][3:0] _GEN_22 =
    {{4'h0},
     ...
     {removalIndex},
     {heapSizeReg[3:0]},
     {_heapifier_io_control_idx_T_1[3:0]},
     {heapSizeReg[3:0]},
     {4'h0},
     {heapSizeReg[3:0]}};
  ...
  wire [3:0]       _heapifier_io_control_idx_T_6 = removalIndex - 4'h1;
  wire             _GEN_28 = stateReg == 4'hA;
  wire [4:0]       _GEN_29 = {removalIndex, 1'h0} + 5'h1;
  wire             _GEN_30 = ~io_cmd_op & ~_heapifier_io_control_swapped & ~(_GEN_29[4]);
  always @(posedge clock) begin
    if (reset) begin
      stateReg <= 4'h0;
      heapSizeReg <= 5'h0;
      ...
      automatic logic             _GEN_32 = heapSizeReg == 5'h1;
      automatic logic             _GEN_33;
      automatic logic             _GEN_34;
      automatic logic             _GEN_35;
      automatic logic [15:0][3:0] _GEN_36;
      _GEN_31 = heapSizeReg == 5'h10;
      ...
      if (_GEN) begin
        ...
        automatic logic [4:0] _incHeapsize_T;
        _incHeapsize_T = heapSizeReg + 5'h1;
        if (_GEN_4)
  ...
  Heapifier heapifier (
    ...
    .io_control_idx
      (_GEN_25
         ? heapSizeReg[3:0]
         : _GEN_1
             ? (heapSizeReg < 5'h3 ? 4'h0 : _heapifier_io_control_idx_T_1[4:1])
             : _GEN_18
                 ? heapSizeReg[3:0]
                 : _GEN_15
                     ? 4'h0
                     : _GEN_20
                         ...
                         : _GEN_21
                             ? {1'h0,
                                removalIndex < 4'h3
                                  ? 3'h0
                                  : _heapifier_io_control_idx_T_6[3:1]}
  ...
  assign io_rdPort_address =
    _GEN | ~(_GEN_7 | ~_GEN_6) ? _rdIndexToRam_T[3:1] : _heapifier_io_rdPort_address;
  assign io_wrPort_address =
              ...
              : _GEN_8
                  ...
                  : _GEN_14
                      ...
                      : _GEN_15
                          ? _GEN_10
                          : _GEN_20
                              ? (wrIndexOffset ? _heapifier_io_wrPort_data_0_id : 5'h1F)
              ...
              : _GEN_8
                  ...
                  : _GEN_14
                      ...
                      : _GEN_15
                          ? _GEN_12
                          : _GEN_20
                              ? (wrIndexOffset ? 5'h1F : _heapifier_io_wrPort_data_1_id)
...
module PriorityQueue(
  ...
  wire [2:0]  _queue_io_rdPort_address;
  wire [2:0]  _queue_io_wrPort_address;
  wire [1:0]  _queue_io_wrPort_mask;
  wire [31:0] _queue_io_wrPort_data_0_event_superCycle;
  wire [4:0]  _queue_io_wrPort_data_0_id;
  wire [31:0] _queue_io_wrPort_data_1_event_superCycle;
  wire [4:0]  _queue_io_wrPort_data_1_id;
  wire        _queue_io_wrPort_write;
  wire [4:0]  _queue_io_srch_refID;
  wire [4:0]  _queue_io_srch_heapSize;
  wire        _queue_io_srch_search;
  wire [31:0] _mem_rd_data_0_event_superCycle;
  wire [4:0]  _mem_rd_data_0_id;
  wire [31:0] _mem_rd_data_1_event_superCycle;
  wire [4:0]  _mem_rd_data_1_id;
  wire [3:0]  _mem_srch_res;
